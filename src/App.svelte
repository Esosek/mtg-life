...
<main class="relative max-w-sm text-center mx-auto h-lvh grid">
  ...
  <div class="absolute top-0 left-0 right-0 bottom-0 flex items-center justify-center pointer-events-none">
    <div class="h-[0.3rem] bg-neutral-200/95 w-full"></div>
    <div class="absolute size-14 flex justify-center items-center bg-neutral-200/95 rounded-full">
