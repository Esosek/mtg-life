  ...
  mechanics: [
    {
      name: 'Spacecraft',
      description:
        "Station (Tap another creature you control: Put charge counters equal to its power on this Spacecraft) Station only as a sorcery. It's an artifact creature at X+.",
      examples: [
    ...
    },
    {
      name: 'Warp',
      description:
        'Warp X (You may cast this card from your hand for its warp cost. Exile this creature at the beginning of the next end step, then you may cast it from exile on a later turn.)',
      examples: [
